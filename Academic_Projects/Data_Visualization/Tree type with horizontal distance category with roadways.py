...
dataset = pd.read_csv('C:/Users/Ritu/Desktop/MSc. DA Project/visualization code/Patches.csv') 
...
fig = go.Figure(data=[go.Scatter3d(
    ...
    marker=dict(color=Y, colorscale='Rainbow', opacity=0.5),text=[f'horizontal distance: {a}; horizontal distance:{b}; tree:{c}' 
                                ...
                                hoverinfo='text'
)],layout=go.Layout(title = 'Tree type with horizontal distance category with roadways',barmode = 'group'))
